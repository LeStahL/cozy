...
crinkler.exe nswv.obj /out:no-synthwave.exe /ENTRY:demo /SUBSYSTEM:Windows /LARGEADDRESSAWARE /PROGRESSGUI /COMPMODE:VERYSLOW /PRIORITY:NORMAL User32.lib Winmm.lib opengl32.lib Kernel32.lib Gdi32.lib /LIBPATH:"C:\Program Files (x86)\Windows Kits\10\Lib\10.0.17763.0\um\x86"
